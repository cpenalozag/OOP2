...
/**
 * Clase que representa un hilo de ejecución cuando se quiere eliminar un correo.
 */
public class ThreadEliminarCorreo extends Thread
{
    ...
    /**
     * Inicia la ejecución del hilo que marca como leído el correo.<br>
     * <b>post: </b> Se marcó como leído el correo.<br>
     */
    public void run( )
    {
        try
