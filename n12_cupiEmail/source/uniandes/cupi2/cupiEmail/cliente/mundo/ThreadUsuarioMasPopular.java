...
/**
 * Clase que representa un hilo de ejecución cuando se quiere consultar el usuario mas popular.
 */
public class ThreadUsuarioMasPopular extends Thread
{
    ...
    /**
     * Crea un nuevo hilo para consultar el usuario más popular.<br>
    ...
    /**
     * Inicia la ejecución del hilo que realiza la consulta del usuario más popular.<br>
     * <b>post: </b> Se consultó el usuario más popular.<br>
     */
    public void run( )
    {
        try
