...
/**
 * Clase que representa un hilo de ejecución cuando se quiere consultar los correos enviados.
 */
public class ThreadConsultarEnviados extends Thread
{
    ...
    /**
     * Inicia la ejecución del hilo que realiza la consulta de correos enviados.<br>
