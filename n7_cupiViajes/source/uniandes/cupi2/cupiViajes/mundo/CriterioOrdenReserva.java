...
/**
 * Enumeraci�n con los posibles citerios de ordenamiento
 * @author Alvaro
 *
 */
public enum CriterioOrdenReserva 
{
    ...
    RESERVA_AEROLINEA_PERSONAS_ASC("Aerolínea y nombre cliente ascendente", new ComparadorHotelEstrellas(), true),
    RESERVA_AEROLINEA_PERSONAS_DESC("Aerolínea y nombre cliente descendente", new ComparadorHotelEstrellas(), false);
    ...
    /**
     * Da el nombre del criterio de comparaci�n
     * @return nombre
     */
