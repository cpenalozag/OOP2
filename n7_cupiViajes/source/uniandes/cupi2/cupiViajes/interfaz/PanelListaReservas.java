...
public class PanelListaReservas extends JPanel implements ListSelectionListener, ActionListener
{
    ...
    /**
     * Selecciona la reserva que se est� visualizando.
     ...
     * @param pEvento Evento de selecci�n de un elemento de la lista de reservas. pEvento != null.
     */
